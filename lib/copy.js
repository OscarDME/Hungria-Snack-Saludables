...
// loncherafeliz.aprende-hoy.shop. Cualquier cambio de texto ocurre itt (aquí).
...
export const copy = {
  ...
  benefits: {
    ...
    items: [
      ...
      {
        icon: "🥦",
        title: "Az állandó aggódásnak az étkezésük miatt",
      ...
      },
      {
        ...
        desc: "Ínycsiklandó receptek, amelyekkel elérheted, hogy a gyerekek alig várják, mit készítesz nekik.",
      },
    ],
  },
  ...
  transformation: {
    ...
    after: {
      tag: "UTÁNA",
      title: "Boldogok, élettel teliek és energikusak",
      desc: "Természetes, finom és tápláló nasik, amiket a gyerekek imádnak",
    },
    image: {
      src: "/kids-transformation.webp",
      alt: "Átalakulás: szomorú gyerek egészségtelen étellel, kontra boldog gyerek egészséges nasival",
    },
  },
    ...
    items: [
      {
        ...
        quote:
          "Soha nem gondoltam volna, hogy a kisfiam ilyen gyorsan megszereti az egészséges nasikat! A receptek nemcsak nagyon egyszerűek, de imádja is őket. Köszönöm, hogy megkönnyítettétek az életem! A legjobb befektetés, amit valaha csináltam.",
      },
      {
        initial: "N",
        name: "Norbert",
        ...
        quote:
          "Korábban sokat aggódtam amiatt, hogy mit adok a gyerekeimnek, de ezzel a könyvvel rendkívül finom és egészséges alternatívákat találtam. Most már mindenki jobban eszik, én pedig sokkal nyugodtabb vagyok!",
      },
      {
        initial: "E",
        name: "Eszter",
        ...
        quote:
          "Szakemberként megerősíthetem, hogy ezek a receptek tökéletesen kiegyensúlyozottak. A gyerekeim imádják őket, én pedig nyugodt vagyok, mert tudom, hogy jókat esznek. Minden szülőnek szívből ajánlom!",
      },
      {
        initial: "D",
        name: "Dóra",
        ...
        quote:
          "A sűrű beosztásom miatt egyáltalán nem volt időm főzni. Ez a könyv mindent megváltoztatott: 15 perces receptek, amiket a gyerekeim újra és újra kérnek. Minden fillért megért! Már az összes barátnőmnek ajánlottam.",
      },
    ],
  },
  ...
  whatYouGet: {
    ...
    items: [
      "500 gyors és tápláló recept reggelire, ebédre, vacsorára és iskolai tízóraira",
      "Kész heti menük + gazdaságos bevásárlólisták",
      "Ötletek a reggeli, uzsonna és vacsora tökéletes kombinálásához",
      "Könnyen követhető, lépésről lépésre bemutatott elkészítési útmutatók",
      "Lista az egészséges helyettesítőkről, ha épp hiányzik egy összetevő",
  ...
  bonuses: {
    flagline: "🔥 CSAK MA!",
    headline: "Szerezz több mint 35 000 Ft értékű INGYENES bónuszt, ha most vásárolsz",
    subheadline:
    ...
    items: [
      {
        ...
        desc: "Készítsd el a kedvenc ételeik egészséges változatát hozzáadott cukor és glutén nélkül, szó szerint percek alatt.",
      },
      {
        value: "7 990 Ft",
        title: "Gyakorlati útmutató az ételek rendszerezéséhez és fagyasztásához",
        desc: "Tanuld meg, hogyan készíts el mindent egyszerre, hogy egész hétre kész ételed legyen, napi kevesebb mint 30 perc konyhai munkával.",
      },
      {
        value: "5 990 Ft",
        title: "Speciális receptek allergiás gyermekeknek",
        desc: "Biztonságos és finom receptek, a leggyakoribb ételallergiákra (tej, tojás, szója, földimogyoró) szabva.",
      },
      {
        value: "5 990 Ft",
        title: "Ínycsiklandó és egészséges desszertreceptek",
        desc: "Cseréld le a feldolgozott édességeket kizárólag természetes összetevőkből készült, egészséges finomságokra.",
      },
      {
        value: "5 990 Ft",
        title: "Egészséges és könnyen elkészíthető frissen préselt gyümölcslevek",
        desc: "Praktikus receptek természetes, tápláló és isteni finom levekre, amelyek feldobják a családod napját.",
      },
    ],
  ...
  exclusiveBonuses: {
    ...
    headline: "Csak ma! Szerezd meg ezeket az extra exkluzív bónuszokat is",
    subheadline: "hogy átalakítsd a gyermekeid egészségét",
    badgeLabel: "INGYENES",
    valueLabel: "Értéke:",
    items: [
      {
        value: "7 490 Ft",
        title: "Házi gyümölcsös gumicukrok magas C-vitamin tartalommal",
        desc: "Tanuld meg, hogyan készíts természetes, C-vitaminban gazdag gumicukrot, hogy szórakoztató és finom módon erősítsd gyermekeid immunrendszerét. Hozzáadott cukor nélkül, 100%-ban természetes és tele tápanyagokkal!",
      },
      {
        value: "7 990 Ft",
        title: "Hogyan szerettessük meg a gyerekekkel a zöldségeket",
        desc: "Változtasd a zöldségeket egy ízletes és vidám kalanddá a gyerekek számára. Egyszerű receptek, amelyek segítségével örömmel fognak zöldségeket enni.",
      },
      {
        value: "6 990 Ft",
        title: "Gyors nasi útmutató válogatós gyerekeknek",
        desc: "Fedezz fel egyszerű és tápláló, gyenge étvágyú gyerekeknek is ideális nasikat, amelyek segítenek nekik az egészséges és nagyon finom étkezésben.",
      },
      {
        value: "6 990 Ft",
        title: "Szuperélelmiszer útmutató gyerekeknek",
        desc: "Tudd meg, hogyan építs be olyan szuperélelmiszereket az étrendbe, amelyek javítják a gyermekeid egészségét és energiaszintjét, olyan egyszerű receptekkel, amelyek fontos tápanyagokat biztosítanak.",
      },
    ],
  ...
  finalCta: {
    ...
    imageAlt:
      "Teljes csomag: Egészséges Gyerek Nasik e-könyv + 9 Bónusz",
  ...
  guarantee: {
    ...
    body: "Annyira biztosak vagyunk benne, hogy imádni fogod ezt a kézikönyvet, hogy feltétel nélküli 14 napos garanciát vállalunk. Ha bármilyen okból nem vagy 100%-ig elégedett, minden fillért visszatérítünk. Felesleges kérdések és bonyodalmak nélkül.",
    ...
    items: [
      {
        ...
        a: "A kézikönyvet a 2 és 12 év közötti korosztályra terveztük, bár a receptek könnyen adaptálhatók és elkészíthetők bármilyen életkorhoz.",
      },
      {
        q: "Allergiás gyerekek számára is megfelelő?",
        a: "Igen! Kínálunk recepteket a leggyakoribb allergiákra szabva, mint a tej, tojás, szója és földimogyoró, így minden gyermek élvezheti a finom és egészséges ételeket.",
      },
      {
        q: "Tudnom kell jól főzni?",
        a: "Nem, a recepteket úgy alkottuk meg, hogy a lehető legkönnyebben követhetők legyenek, kevés hozzávalóval és egyszerű lépésekkel. Még ha nem is vagy profi a konyhában, kiválóan meg fogod tudni csinálni!",
      },
      {
        q: "Drágák az alapanyagok?",
        a: "Nem, az összes alapanyag megfizethető és könnyen beszerezhető bármelyik átlagos szupermarketben. Nem lesz szükséged drága vagy nehezen beszerezhető termékekre.",
      },
      {
        q: "Mennyi ideig tart a nasik elkészítése?",
        a: "A receptek rendkívül gyorsak, a legtöbb rágcsálnivaló kevesebb mint 15 perc alatt elkészül.",
      },
      {
        q: "Fizethetek a saját, helyi valutámban?",
        a: "Igen! A fizetési rendszerünk automatikusan átváltja az összeget az aktuális árfolyamon. Amikor a fizetéshez lépsz, a helyi valutádnak megfelelő árat fogod látni, így nem kell aggódnod a rejtett konverziós díjak miatt. Garantáljuk, hogy a fizetési folyamat egyszerű és teljesen átlátható, bárhol is élj.",
      },
    ],
  },
  ...
  closing: {
    ...
    headline:
      "Ne szalaszd el ezt a kivételes lehetőséget, hogy megreformáld a családod étkezését!",
    subheadline:
      "Teljes Kézikönyv + 9 Bónusz 66 410 Ft értékben AJÁNDÉKBA! Mindez egyetlen éttermi vacsora áráért",
    regularPrice: "77 990 Ft",
    offerPrice: "2990 Ft",
    ctaLabel: "IGEN, KÉREM A KÉZIKÖNYVEMET MOST!",
    trustRow:
      "🔒 100% biztonságos fizetés • ⚡ Azonnali hozzáférés • ✅ 14 napos kockázatmentes pénzvisszafizetési garancia",
  },
